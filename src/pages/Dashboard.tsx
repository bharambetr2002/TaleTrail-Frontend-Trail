...
import { BookOpen, Target, Calendar, TrendingUp, Book, Users } from "lucide-react";
...
export default function Dashboard() {
  ...
  const stats = {
    ...
    avgProgress: userBooks.length > 0 
      ? Math.round(userBooks.reduce((sum, book) => sum + book.progress, 0) / userBooks.length)
      : 0
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-8">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">Here's your reading journey overview</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950/50 dark:to-orange-900/50 border-orange-200 dark:border-orange-800">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-orange-600 dark:text-orange-400">Reading Now</p>
                ...
                <div key={book.id} className="flex items-center gap-4 p-4 border rounded-lg">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-muted-foreground w-12">{book.progress}%</span>
                    </div>
                  </div>
      ...
      {stats.totalBooks === 0 && (
        <Card className="text-center py-12">
          <CardContent>
            ...
            <h3 className="text-xl font-semibold mb-2">Start Your Reading Journey</h3>
