...
import { User, Edit, Save, X, BookOpen, FileText, Calendar } from "lucide-react";
...
export default function UserProfile() {
  ...
  const loadProfile = async () => {
    try {
      ...
      // Load user's blogs
      const blogsResponse = await api.getBlogs(profile?.id);
          ...
          <Card>
            <CardContent className="p-6">
              <div className="text-center py-12 text-muted-foreground">
                ...
                <h3 className="text-xl font-semibold mb-2">Reading Activity</h3>
